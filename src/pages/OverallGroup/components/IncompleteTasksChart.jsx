...
const data = [
  { name: "Hiring", value: 400 },
  { name: "Interviews", value: 600 },
  { name: "Shortlisting", value: 500 },
  { name: "Contracts", value: 550 },
  { name: "Next task", value: 450 },
]

export default function IncompleteTasksChart() {
  return (
