...
const AddCore = ({ handleActivityAddCore }) => {
  ...
  React.useEffect(() => {
    const handleEsc = (e) => {
      if (e.key === "Escape") handleActivityAddCore();
    };
    window.addEventListener("keydown", handleEsc);
    return () => window.removeEventListener("keydown", handleEsc);
  }, [handleActivityAddCore]);
    ...
    <div className="add_core">
      <div className="add_core__container">
        <div className="add_core__header">
          ...
          <button className="add_core__close" onClick={handleActivityAddCore}>
            &times;
          </button>
        </div>
      ...
      <div className="add_core__footer">
        <button className="add_core__cancel" onClick={handleActivityAddCore}>
          Cancel
        </button>
